...
// @version      4.1
// @description  Adds a native-style “WATCH” button on IMDb movie or TV pages with optimized injection, caching, safer handling, and error logging.
// @author       Nikoboi
...
(function () {
    ...
    // Wrap injection in try/catch for error logging
    function safeInject() {
        try {
            ...
            console.error('IMDb-RePo injection error:', err);
        }
    }
