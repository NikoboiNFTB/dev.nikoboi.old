...
// @version      3.1
// @description  Adds a native-style “WATCH” button on IMDb movie or TV pages, redirecting directly to 111movies with the correct title or episode link using MutationObserver for instant injection.
// @author       Nikoboi
...
(function () {
    ...
    function injectButton(target) {
        ...
        if (isTVPage) {
            ...
            console.log('✅ TV button added (MutationObserver).');
        } else if (isMoviePage) {
            ...
            console.log('✅ MOVIE button added (MutationObserver).');
        } else {
