...
// @version      3.0
// @description  Adds a native-style “WATCH” button on IMDb movie or TV pages, redirecting directly to 111movies with the correct title or episode link.
// @author       Nikoboi
...
(function () {
    ...
    function injectButton() {
        ...
        // Smarter detection using stable aria-label attributes
        ...
        if (isTVPage) {
            ...
            console.warn('⚠️ IMDb-RePo: Could not determine title type (no aria-label match).');
            return false;
        }
